...
export interface ApiAnjuCapabilityAnjuCapability
  ...
  info: {
    displayName: 'Anju Capability';
    pluralName: 'anju-capabilities';
    singularName: 'anju-capability';
  };
  options: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::anju-capability.anju-capability'
    > &
      Schema.Attribute.Private;
...
export interface ApiAnjuIntegrationCardAnjuIntegrationCard
  extends Struct.CollectionTypeSchema {
  collectionName: 'anju_integration_cards';
  info: {
    displayName: 'Anju Integration Card';
    pluralName: 'anju-integration-cards';
    singularName: 'anju-integration-card';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::anju-integration-card.anju-integration-card'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
...
export interface ApiAnjuIntegrationAnjuIntegration
  extends Struct.CollectionTypeSchema {
  collectionName: 'anju_integrations';
  info: {
    displayName: 'Anju Integration Section';
    pluralName: 'anju-integrations';
    singularName: 'anju-integration';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::anju-integration.anju-integration'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiAnjuScenarioAnjuScenario
  extends Struct.CollectionTypeSchema {
  collectionName: 'anju_scenarios';
  info: {
    displayName: 'Anju Scenario';
    pluralName: 'anju-scenarios';
    singularName: 'anju-scenario';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::anju-scenario.anju-scenario'
    > &
      Schema.Attribute.Private;
    order: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiAnjuSectionAnjuSection extends Struct.SingleTypeSchema {
  collectionName: 'anju_sections';
  info: {
    displayName: 'Anju Section';
    pluralName: 'anju-sections';
    singularName: 'anju-section';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiCareerSectionCareerSection extends Struct.SingleTypeSchema {
  collectionName: 'career_sections';
  info: {
    displayName: 'Career Section';
    pluralName: 'career-sections';
    singularName: 'career-section';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::career-section.career-section'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiContactContact extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    eyebrow: Schema.Attribute.String;
    footerCompany: Schema.Attribute.String;
    footerCopyright: Schema.Attribute.String;
    heading: Schema.Attribute.Text;
    helpLabel: Schema.Attribute.String;
    helpPlaceholder: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::contact.contact'
    ...
    specialtiesLabel: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiDemoDemo extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['AI \u00B7 ANJU', 'AI \u00B7 ANALYTICS', 'ERP \u00B7 INTEGRATION']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiHomeChatHomeChat extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: 'Home Chat';
    pluralName: 'home-chats';
    singularName: 'home-chat';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    anjuResponse1: Schema.Attribute.Text;
    anjuResponse2: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::home-chat.home-chat'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    thinkingText: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    userMessage1: Schema.Attribute.String;
    userMessage2: Schema.Attribute.String;
  };
}
...
export interface ApiHomeHome extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    anjuLabel: Schema.Attribute.String;
    anjuStatLabel: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    erpStat: Schema.Attribute.String;
    erpStatLabel: Schema.Attribute.String;
    eyebrow: Schema.Attribute.String;
    heading: Schema.Attribute.String;
    headingAccent: Schema.Attribute.String;
    industryStat: Schema.Attribute.String;
    industryStatLabel: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::home.home'> &
      Schema.Attribute.Private;
    opensourceStat: Schema.Attribute.String;
    opensourceStatLabel: Schema.Attribute.String;
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<['AI', 'ERP']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiWhyUsSectionWhyUsSection extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    erpLabel: Schema.Attribute.String;
    eyebrow: Schema.Attribute.String;
    heading: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
...
export interface ApiWhyUsWhyUs extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    body: Schema.Attribute.Text;
    category: Schema.Attribute.Enumeration<['AI', 'ERP', 'BOTH']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
